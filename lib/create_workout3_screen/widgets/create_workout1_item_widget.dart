...
class CreateWorkout1ItemWidget extends StatelessWidget {
  CreateWorkout1ItemWidget(this.createWorkout1ItemModelObj);

  CreateWorkout1ItemModel createWorkout1ItemModelObj;

  var controller = Get.find<CreateWorkout3Controller>();
