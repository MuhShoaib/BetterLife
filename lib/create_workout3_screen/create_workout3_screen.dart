...
import '../create_workout3_screen/widgets/create_workout1_item_widget.dart';
import 'controller/create_workout3_controller.dart';
import 'models/create_workout1_item_model.dart';
// import 'package:better_life/core/app_export.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class CreateWorkout3Screen extends GetWidget<CreateWorkout3Controller> {
                                                        ...
                                                        child: Obx(() =>
                                                            ListView.builder(
                                                                ...
                                                                itemCount: controller
                                                                    .createWorkout3ModelObj
                                                                    .value
                                                                    .createWorkout1ItemList
                                                                    .length,
                                                                itemBuilder: (
                                                                    context,
                                                                    index) {
                                                                  CreateWorkout1ItemModel model = controller
                                                                      .createWorkout3ModelObj
                                                                      .value
                                                                      .createWorkout1ItemList[index];
                                                                  return CreateWorkout1ItemWidget(
                                                                      model);
                                                                })))),
                                                Align(alignment: Alignment
                                                    .topLeft,
